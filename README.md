...
| [Вариант 1. Автоматический скрипт](./autoinstaller/) | [Вариант 2. Пошаговый ручной гайд](./manual_setup/) |
| :--- | :--- |
...
| * Полностью автоматическая сборка. <br>* Установка за 1 команду (Python 3). <br>* Преднастроенный тюнинг `php.ini`. <br>* Авто-генерация SSL-сертификатов на 10 лет. <br>* Тихая установка Nextcloud через утилиту `occ`. | * Полный контроль над каждым шагом. <br>*  Пошаговое конфигурирование базы данных MariaDB. <br>* Оптимизация виртуального хоста Nginx (HTTP/2). <br>* Веб-мастер завершения установки. |
